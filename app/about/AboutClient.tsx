            ...
            >
              ...
              <div className="space-y-4 font-inter text-gray-600 text-base leading-relaxed">
                ...
                <p>
                  ...
                  persistence, the decision was clear: go back and build the
                  resource that should have existed from the start. Rubani Hub
              ...
              <div className="mt-8 flex gap-4">
                <Link
                  href="/contact"
                  className="bg-brand-blue hover:bg-brand-blue-light text-white font-montserrat font-bold text-sm px-7 py-3.5 rounded-xl transition-all duration-300"
                >
                  Start Your Journey
                </Link>
                <Link
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {values.map((val, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                className="bg-white rounded-2xl p-7 border border-gray-100 hover:-translate-y-1 transition-all duration-300 group"
              >
